...
import {View,Text, Dimensions, StyleSheet, TouchableHighlight, Animated,TouchableOpacity} from 'react-native';
...
export default class AddButton extends React.Component{
    ...
    render(){
        ...
        const addOverlayY=this.mode.interpolate({
            inputRange:[0,1],
            outputRange:[deviceWindow.height * 0.27,deviceWindow.height * -0.50]
        });

        return(
            <View styles={{position:"absolute", alignItems:"center"}}>
                <Animated.View style={{position:"absolute", left:addOverlayX, top:addOverlayY}}>
...
const styles=StyleSheet.create({
    ...
    overlaycard:{
      ...
      categoryButton:{
        ...
        justifyContent:"center",
        borderRadius:7,
        width:deviceWindow.width * 0.50,
        height:deviceWindow.height * 0.50,
        // position:"absolute",
